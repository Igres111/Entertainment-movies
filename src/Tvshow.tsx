                  ...
                  >
                    <div className="relative ">
                      ...
                      <button
                        ...
                        className="w-8 h-8 flex justify-center items-center bg-hole/50 opacity-50 absolute top-0 lg:ml-auto lg:right-6 rounded-full ml-[124px] mt-2 hover:bg-white/50  hover:text-black"
                      >
                        {el.isBookmarked ? (
                          <svg
                            width="12"
